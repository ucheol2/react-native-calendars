    ...
    if (row.getTime) {
      return (
        <Calendar
          ...
          animatedCalendarHeight={this.props.animatedCalendarHeight}
      ...
      const height = this.props.animatable ? (this.props.animated ? this.props.animatedCalendarHeight : this.props.calendarHeight) : this.props.calendarHeight
      return (
        <View style={[{height, width: this.props.calendarWidth}, this.style.placeholder]}>
